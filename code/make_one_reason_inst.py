...
def main(args):
    ...
    label_template = "\nLabel: "
    instruction = "Instruction: Explain the reasoning and then select the correct label from entailment, neutral, or contradiction."

    assert not args.train_file.startswith("qqp_"), "The instruction needs to be modified for QQP."
    ...
    outfile_name = args.train_file.replace("_all_reason", "_one_reason_inst")
    output_list = []
