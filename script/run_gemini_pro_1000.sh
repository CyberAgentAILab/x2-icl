...
SNLI_TESTS=('data/testset/snli.json' 'data/testset/hans.json' 'data/testset/iscs.json' 'data/testset/nan.json' 'data/testset/st.json' 'data/testset/picd.json' 'data/testset/pisp.json')
SNLI_TASKS=('ESNLI' 'HANS' 'ISCS' 'NAN' 'ST' 'PICD' 'PISP')
